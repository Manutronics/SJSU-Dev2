...
#include "L1_Peripheral/lpc18xx/system_controller.hpp"
#include "L1_Peripheral/lpc18xx/uart.hpp"
...
namespace
{
/// Clock configuration object for LPC18xx devices.
sjsu::lpc18xx::SystemController::ClockConfiguration_t clock_configuration;

/// Create lpc18xx system controller to be used by low level initialization.
sjsu::lpc18xx::SystemController system_controller(clock_configuration);
...
sjsu::lpc18xx::Uart uart0(sjsu::lpc18xx::UartPort::kUart0);
...
sjsu::cortex::InterruptController<sjsu::lpc18xx::kNumberOfIrqs,
                                  __NVIC_PRIO_BITS>
    interrupt_controller;

int lpc18xxStdOut(const char * data, size_t length)
{
  uart0.Write(reinterpret_cast<const uint8_t *>(data), length);
  return length;
}

int lpc18xxStdIn(char * data, size_t length)
{
...
void InitializePlatform()
{
  ...
  sjsu::newlib::SetStdout(lpc18xxStdOut);
  sjsu::newlib::SetStdin(lpc18xxStdIn);
