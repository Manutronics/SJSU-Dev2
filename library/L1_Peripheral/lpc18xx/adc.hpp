...
///
/// ```
/// sjsu::lpc18xx::Adc adc(sjsu::lpc18xx::AdcChannel::kChannel0);
/// ```
struct AdcChannel  // NOLINT
{
 ...
 public:
  ...
  /// Pass this to the lpc18xx::Adc class to utilize adc channel0.
  ...
  /// Pass this to the lpc18xx::Adc class to utilize adc channel1.
  ...
  /// Pass this to the lpc18xx::Adc class to utilize adc channel2.
  ...
  /// Pass this to the lpc18xx::Adc class to utilize adc channel3.
  ...
  /// Pass this to the lpc18xx::Adc class to utilize adc channel4.
  ...
  /// Pass this to the lpc18xx::Adc class to utilize adc channel5.
  ...
  /// Pass this to the lpc18xx::Adc class to utilize adc channel6.
  ...
  /// Pass this to the lpc18xx::Adc class to utilize adc channel7.
