...
namespace lpc18xx
{
// Bring in and using the LPC40xx driver as it is compatible with the lpc18xx
// peripheral.
...
struct I2cBus  // NOLINT
{
 ...
 public:
  // Definition for I2C bus 0 for lpc18xx.
  ...
  /// Definition for I2C bus 1 for lpc18xx.
  ...
  /// Definition for I2C bus 2 for lpc18xx.
