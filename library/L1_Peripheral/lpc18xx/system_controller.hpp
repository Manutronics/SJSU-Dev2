...
namespace lpc18xx
{
/// System controller for the lpc18xx series of MCUs.
class SystemController final : public sjsu::SystemController
{
 public:
  /// lpc18xx Peripheral Power On Values:
  /// The kDeviceId of each peripheral corresponds to the peripheral's power on
  /// bit position within the lpc18xx System Controller's PCONP register.
  ///
  ...
  /// lpc18xx Peripheral Clock Selection Values:
  /// The `device_id` of each peripheral clock corresponds to the peripheral's
  /// clock selection bit position within the lpc18xx System Controller's
  /// PCLKSEL registers.
  class Clocks
  {
   public:
